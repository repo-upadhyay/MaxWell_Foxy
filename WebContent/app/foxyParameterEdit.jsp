    ...
    <table class="box" width="100%">
        <tr><td>
            ...
            <h:panelGrid id="UpdAddGrid" styleClass="tablebg" width="100%">
                <%-- Title for Edit --%>
                <h:outputText value="Editing Parameter" styleClass="smalltitle"/>
                ...
                <h:form id="UpdAddForm">
                    <h:panelGrid id="UpdAddInput" columns="2" columnClasses="FOX_LABEL_COL, FOX_INPUT_COL" width="50%">
                        ...
                        <h:panelGroup>
                            <h:selectOneMenu id="category" styleClass="FOX_INPUT_RO" required="true" 
                                disabled="true" value="#{foxyParameter.dbParameterBean.category}">
                        ...
                        <h:panelGroup>                                               
                            <t:inputTextHelp id="Code" styleClass="FOX_INPUT_RO"
                                ...
                                value="#{foxyParameter.dbParameterBean.code}">
                            </t:inputTextHelp>
                        ...
                        <h:panelGroup>
                            <t:inputTextHelp id="ShortDesc" styleClass="FOX_INPUT" 
                                helpText="Text"
                                maxlength="10" size="10" required="true" 
                                value="#{foxyParameter.dbParameterBean.shortDesc}">
                            </t:inputTextHelp> 
                        ...
                        <h:panelGroup>
                            <t:inputTextHelp id="Description" styleClass="FOX_INPUT" 
                                ...
                                value="#{foxyParameter.dbParameterBean.description}">
                            </t:inputTextHelp> 
                        ...
                        <h:panelGroup>
                            <t:inputTextHelp id="seq" styleClass="FOX_INPUT" 
                                ...
                                value="#{foxyParameter.dbParameterBean.sequence}">
                        ...
                        <h:panelGroup>
                        <h:selectOneMenu id="Status" styleClass="FOX_INPUT" required="true" value="#{foxyParameter.dbParameterBean.status}">
                    ...
                    <h:panelGrid id="AddButton" columns="1" columnClasses="FOX_BUTTON" width="50%">
                        <h:panelGroup>
                            <h:commandButton id="Save"  value="Save" action="#{foxyParameter.saveEdit}"/>
                        </h:panelGroup>
                    </h:panelGrid>
