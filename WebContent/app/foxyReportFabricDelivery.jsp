...
<f:view>
    ...
    <%-- Panel for Search --%>
    <%-- h:panelGrid id="SearchGrid" styleClass="tablebg" width="100%" rendered="#{foxyFabricDeliveryRpt.search}" --%>
    <h:panelGrid id="SearchGrid" styleClass="tablebg" width="100%"  rendered="#{not foxyFabricDeliveryRpt.list}">
        <h:outputText value="Fabric Delivery Report" styleClass="smalltitle" />
        <%--h:form id="SearchForm" rendered="#{foxyFabricDeliveryRpt.search}" --%>

        <h:form id="SearchForm">
            <t:saveState value="#{foxyFabricDeliveryRpt.country}"/>
            <t:saveState value="#{foxyFabricDeliveryRpt.mainfactory}"/>
            <t:saveState value="#{foxyFabricDeliveryRpt.custCode}"/>
            <t:saveState value="#{foxyFabricDeliveryRpt.custDivision}"/>
            <t:saveState value="#{foxyFabricDeliveryRpt.brand}"/>
            <t:saveState value="#{foxyFabricDeliveryRpt.cnameCode}"/>
            ...
            <h:panelGrid id="SearchInput" columns="2" columnClasses="FOX_LABEL_COL, FOX_INPUT_COL" width="50%">                        
                ...
                <h:panelGroup >
                    <h:selectOneMenu id="CName" value="#{foxyFabricDeliveryRpt.cnameCode}" styleClass="FOX_INPUT" required="true" immediate="false">
                ...
                <h:panelGroup>
                    <a4j:region id="ajaxregioncountryfactory" renderRegionOnly="false" selfRendered="true">
                        <h:selectOneMenu id="Country" styleClass="FOX_INPUT" 
                                         required="true" 
                                         immediate="true"
                                         value="#{foxyFabricDeliveryRpt.country}">
                ...
                <h:panelGroup>
                    <h:selectOneMenu id="factory" styleClass="FOX_INPUT" 
                                     required="true" 
                                     immediate="true"
                                     value="#{foxyFabricDeliveryRpt.mainfactory}">
                        <f:selectItems value="#{foxyFabricDeliveryRpt.factoryByCountryList}"/>
                    </h:selectOneMenu>
                ...
                <h:panelGroup>
                    <a4j:region id="ajaxregion1" renderRegionOnly="false" selfRendered="true">
                        <h:selectOneMenu id="CustomerCode" styleClass="FOX_INPUT" value="#{foxyFabricDeliveryRpt.custCode}"
                ...
                <h:panelGroup>
                    <a4j:region id="ajaxregion2" renderRegionOnly="false" selfRendered="true">
                        <h:selectOneMenu id="BrandCode" styleClass="FOX_INPUT" value="#{foxyFabricDeliveryRpt.brand}"
                                         style="width:220px; "  required="false" immediate="true"> 
                            <f:selectItems value="#{foxyFabricDeliveryRpt.brandItemsList}"/>
                            <a4j:support event="onchange"  
                ...
                <h:panelGroup>                              
                    <h:selectOneMenu id="CustomerDivision" styleClass="FOX_INPUT" value="#{foxyFabricDeliveryRpt.custDivision}"
                                     style="width:220px; " required="false" immediate="true"> 
                        <f:selectItems value="#{foxyFabricDeliveryRpt.divisionItemsList}"/>
                    </h:selectOneMenu>                    
                ...
                <h:panelGroup>
                    <h:selectOneMenu id="Season" styleClass="FOX_INPUT" required="false" value="#{foxyFabricDeliveryRpt.season}">
                ...
                <h:panelGroup>
                    <h:selectOneMenu id="Graphics" styleClass="FOX_INPUT" required="false" value="#{foxyFabricDeliveryRpt.graphicTypeCode}">
                ...
                <h:panelGroup>
                    <h:selectOneMenu id="Colouring" styleClass="FOX_INPUT" required="false" value="#{foxyFabricDeliveryRpt.colourTypeCode}">
                        <f:selectItems value="#{listData.colourTypeList}"/>
                    </h:selectOneMenu>
                    <h:message errorClass="FOX_ERROR" for="Colouring" showDetail="true" showSummary="true"/>
                </h:panelGroup> 

                <t:outputLabel for="FromDate" value="Fabric Del Date From:" />
                <h:panelGroup>
                    <t:inputCalendar id="FromDate" styleClass="FOX_INPUT" value="#{foxyFabricDeliveryRpt.fromDate}"  
                ...
                <h:panelGroup>
                    <t:inputCalendar id="ToDate" styleClass="FOX_INPUT" value="#{foxyFabricDeliveryRpt.toDate}"  
                                     required="true" popupDateFormat="yyyyMMdd" renderAsPopup="true"
                                     helpText="YYYYMMDD" />    
                ...
                <h:panelGroup>                              
                    <h:selectOneMenu id="UpdUserId" styleClass="FOX_INPUT" value="#{foxyFabricDeliveryRpt.userid}"
                                     style="width:220px; " required="false" immediate="true"> 
                        <f:selectItems value="#{foxyFabricDeliveryRpt.userItemsList}"/>
                    </h:selectOneMenu>                    
                    <h:message errorClass="FOX_ERROR" for="UpdUserId" showDetail="true" showSummary="true"/>
                </h:panelGroup>                                

                <h:commandButton id="Submit"  value="Submit" action="#{foxyFabricDeliveryRpt.search}"/>
                <h:commandButton id="getXLSX" value="Extract Excel XLSX" action="#{foxyFabricDeliveryRpt.CustSalesListModelXLSX}">
    ...
    <%-- Panel for Listing --%>
    <h:panelGrid id="ListOrderGrid" styleClass="tablebg" rendered="#{foxyFabricDeliveryRpt.list}" width="100%">        
        <h:form id="ListReportForm">
            <h:panelGrid id="Top" columns="1" columnClasses="FOX_LABEL_COL, FOX_INPUT_COL" width="100%">

                <h:outputText value="Fabric Delivery Report #{foxyFabricDeliveryRpt.title}" styleClass="smalltitle" />
            </h:panelGrid>
            <h:panelGrid id="ListDisplay" columns="1" width="100%">
                <t:dataTable value="#{foxyFabricDeliveryRpt.custSalesListModel}" var="custOrder"
                             id="DetailData"
