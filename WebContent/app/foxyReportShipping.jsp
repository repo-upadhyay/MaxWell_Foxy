    ...
    <h:panelGrid id="SearchGrid" styleClass="tablebg" rendered="#{not foxyShippingReports.list}" width="100%">
        ...
        <h:form id="SearchForm">
            ...
            <h:panelGrid id="SearchInput" columns="2" columnClasses="FOX_LABEL_COL, FOX_INPUT_COL" width="50%">
                ...
                <h:panelGroup>
                    <t:inputCalendar id="FromDate" styleClass="FOX_INPUT" value="#{foxyShippingReports.fromDate}"  
                ...
                <h:panelGroup>
                    <t:inputCalendar id="ToDate" styleClass="FOX_INPUT" value="#{foxyShippingReports.toDate}"  
                                     popupDateFormat="yyyyMMdd" renderAsPopup="true"
                                     helpText="YYYYMMDD" required="true"/>    
