...
<f:view>
    ...
    <table class='box' width='100%'>
        <tr><td>    
            ...
            <t:saveState value="#{foxyCustomerDivision.custDivBean.custCode}"/>
            
            <h:messages errorClass="FOX_ERROR" showDetail="true" showSummary="true"/>
            <h:panelGrid id="AddCustomerDivGrid" styleClass="tablebg" width="100%">
                <h:outputText value="New Division for customer" styleClass="smalltitle" />
                <h:form id="AddCustomerDivisionForm">
                    
                    <h:panelGrid id="division" columns="1" columnClasses="FOX_INPUT_COL" width="100%">
                        <%-- Note that a4j:region [selfRendered="true"] is mondatory for myfaces, else inconsistent behavior--%>
                        <h:panelGrid id="divisiondetail" columns="2" columnClasses="FOX_LABEL_COL, FOX_INPUT_COL" width="50%">                            
                            ...
                            <h:panelGroup>                                
                                <a4j:region id="ajaxregion1" renderRegionOnly="false" selfRendered="true">
                                    <h:selectOneMenu id="Customer_Code" styleClass="FOX_INPUT" value="#{foxyCustomerDivision.custDivBean.custCode}"
                                        style="width:180px; height:25px " required="true" immediate="false"> 
                            ...
                            <h:panelGroup>
                                <h:selectOneMenu id="BrandCode" styleClass="FOX_INPUT" value="#{foxyCustomerDivision.custDivBean.brandCode}"
                                    style="width:220px; height:25px "  required="true" immediate="true"> 
                                    <f:selectItems value="#{foxyCustomerDivision.brandItemsList}"/>
                                </h:selectOneMenu>
                            ...
                            <h:panelGroup>
                                <t:inputTextHelp id="DivisionCode" styleClass="FOX_INPUT"  readonly="false"
                                    helpText="Text"
                                    maxlength="10" size="10" required="true"
                                    value="#{foxyCustomerDivision.custDivBean.divCode}">
                                </t:inputTextHelp>
                            ...
                            <h:panelGroup>
                                <t:inputTextHelp id="DivisionDesc" styleClass="FOX_INPUT"  readonly="false"
                                    ...
                                    value="#{foxyCustomerDivision.custDivBean.divDesc}">
                                </t:inputTextHelp>
                            ...
                            value="#{foxyCustomerDivision.custDivBean.status}">
                            ...
                            <h:panelGroup>
                                <h:inputTextarea rows="5" cols="50" id="Remark" styleClass="FOX_INPUT" required="false" 
                                    value="#{foxyCustomerDivision.custDivBean.remark}">
                                </h:inputTextarea>
                    ...
                    <h:panelGrid id="AddButton" columns="1" columnClasses="FOX_BUTTON" width="50%">
                        <h:panelGroup>
                            <h:commandButton id="Save" value="Save" action="#{foxyCustomerDivision.saveAdd}"/>
                        </h:panelGroup>
                    </h:panelGrid>
                </h:form>
            </h:panelGrid>
