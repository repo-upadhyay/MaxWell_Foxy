                                    ...
                                    <h:column>
                                        <h:panelGrid columns="1" width="100%" bgcolor="red" border="0"  cellpadding="0" cellspacing="0">
                                            ...
                                            <h:panelGroup>
                                                ...
                                                <h:outputText value="#{prodSch.refNo}#{prodSch.lotsString}" style="color: #0000FF"/>
                                            </h:panelGroup>
                                        
                                            <h:panelGroup>
                                                <h:outputText value="VesselDate: " style="color: #0000FF"/>
                                                <h:outputText value="#{prodSch.vesselDateRange}" style="color: #0000FF"/>
                                            </h:panelGroup>                                                                               
                                        </h:panelGrid>
