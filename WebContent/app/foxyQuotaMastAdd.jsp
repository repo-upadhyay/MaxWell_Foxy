...
<f:view>
    ...
    <table class="box" width="100%">
        <tr><td>
            ...
            <t:saveState value="#{foxyQuotaMastAdd.quotaCatsMap}"/>
            <t:saveState value="#{foxyQuotaMastAdd.qtaCatBean}"/>
            <t:saveState value="#{foxyQuotaMastAdd.selectedCats}"/>
            <t:saveState value="#{foxyQuotaMastAdd.addQuotaCatSta}"/>
            ...
            <h:panelGrid id="AddQuotaMastGrid" styleClass="tablebg" width="100%">
                <h:outputText value="New Quota Type" styleClass="smalltitle" />
                <h:form id="AddQuotaMastForm">
                    <h:panelGrid id="enq" columns="2" columnClasses="FOX_LABEL_COL, FOX_INPUT_COL" width="50%">
                        ...
                        <h:panelGroup>
                            <h:selectOneMenu id="Country" styleClass="FOX_INPUT" required="true" value="#{foxyQuotaMastAdd.qtaBean.country}">
                        ...
                        <h:panelGroup>
                            <t:inputTextHelp id="QuotaMast_Code" styleClass="FOX_INPUT" readonly="false"
                                ...
                                value="#{foxyQuotaMastAdd.qtaBean.quota}">
                            </t:inputTextHelp>
                        ...
                        <h:panelGroup>                            
                            <t:inputTextHelp id="QuotaMast_Desc" styleClass="FOX_INPUT"
                                ...
                                value="#{foxyQuotaMastAdd.qtaBean.qname}">
                            </t:inputTextHelp>
                        ...
                        <a4j:region id="ajaxregion1" renderRegionOnly="false" selfRendered="true">
                            <h:selectOneMenu id="Category" styleClass="FOX_INPUT" required="false" 
                                value="#{foxyQuotaMastAdd.qtaCatBean.catId}">
                        ...
                        <h:panelGroup>
                            <a4j:region id="ajaxregion2" renderRegionOnly="false" selfRendered="true">
                                <t:inputTextHelp id="Multiplier" styleClass="FOX_INPUT" readonly="false"
                                    ...
                                    value="#{foxyQuotaMastAdd.qtaCatBean.multiplier}">
                                    <a4j:support  event="onchange" ajaxSingle="true" eventsQueue="eq1"/>
                                </t:inputTextHelp>                            
                                <a4j:commandButton id="add_items" value="Add Category"
                                ajaxSingle="false" immediate="true" action="#{foxyQuotaMastAdd.onAddCats}" 
                                reRender="quota_cats,addCatsStatus" eventsQueue="eq1"/>
                            </a4j:region>
                            <t:outputText id="addCatsStatus" styleClass="FOX_ERROR" value="#{foxyQuotaMastAdd.addQuotaCatSta}"/>
                        ...
                        <h:panelGroup>           
                            <a4j:region id="ajaxregion3" renderRegionOnly="false" selfRendered="true">
                                <h:selectManyListbox id="quota_cats" style="width:200px; height:60px " 
                                    ...
                                    required="false" 
                                    immediate="true" 
                                    value="#{foxyQuotaMastAdd.selectedCats}">
                                    <f:selectItems value="#{foxyQuotaMastAdd.quotaCatsList}"/>
                                    <a4j:support  event="onchange" ajaxSingle="true" eventsQueue="eq1"/>
                                </h:selectManyListbox>
                                <a4j:commandButton id="del_items" value="Delete Category" ajaxSingle="false" immediate="true" action="#{foxyQuotaMastAdd.delQuotaCatsListItem}" 
                        ...
                        <h:panelGroup>
                        <h:selectOneMenu id="Status" styleClass="FOX_INPUT" required="true" value="#{foxyQuotaMastAdd.qtaBean.status}">
                    ...
                    <h:panelGrid id="AddButton" columns="1" columnClasses="FOX_BUTTON" width="50%">
                        <h:panelGroup>
                            <h:commandButton id="Save" value="Save" action="#{foxyQuotaMastAdd.saveAdd}"/>
                        </h:panelGroup>
                    </h:panelGrid>
                </h:form>
            </h:panelGrid>
