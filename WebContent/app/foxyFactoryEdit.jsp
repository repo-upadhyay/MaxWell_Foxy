    ...
    <table class="box" width="100%">
        <tr><td>
                ...
                <h:panelGrid id="UpdAddGrid" styleClass="tablebg" width="100%">
                    <%-- Title for Edit --%>
                    <h:outputText value="Editing Factory" styleClass="smalltitle"/>

                    <h:form id="UpdAddForm">
                        <h:panelGrid id="UpdAddInput" columns="2" columnClasses="FOX_LABEL_COL, FOX_INPUT_COL" width="50%">

                            <t:outputLabel for="Code" value="Factory Code:" />
                            <h:panelGroup>                                               
                                <t:inputTextHelp id="Code" styleClass="FOX_INPUT_RO"
                                                 helpText="Text" readonly="true"
                                                 maxlength="10" size="10" required="true" 
                                                 value="#{foxyFactory.dbFactoryBean.factoryCode}">
                                </t:inputTextHelp>
                                <h:message errorClass="FOX_ERROR" for="Code" showDetail="true" showSummary="true"/>
                            </h:panelGroup>


                            <t:outputLabel for="country" value="Factory Located:" />               
                            <h:panelGroup>
                                <h:selectOneMenu id="country" styleClass="FOX_INPUT" required="true" 
                                                 disabled="false" value="#{foxyFactory.dbFactoryBean.countryCode}">
                            ...
                            <h:panelGroup>
                                <t:inputTextHelp id="seq" styleClass="FOX_INPUT" 
                                                 ...
                                                 value="#{foxyFactory.dbFactoryBean.seqNo}">
                            ...
                            <h:panelGroup>
                            <h:selectOneMenu id="Status" styleClass="FOX_INPUT" required="true" value="#{foxyFactory.dbFactoryBean.status}">
                        ...
                        <h:panelGrid id="AddButton" columns="1" columnClasses="FOX_BUTTON" width="50%">
                            <h:panelGroup>
                                <h:commandButton id="Save"  value="Save" action="#{foxyFactory.saveEdit}"/>
                            </h:panelGroup>
                        </h:panelGrid>
