    ...
    <table class='box' width='100%'>
        <tr><td>        
            ...
            <h:panelGrid id="AddCustomerGrid" styleClass="tablebg" width="100%">
                <h:outputText value="New Brand for customer" styleClass="smalltitle" />
                <h:form id="AddCustomerForm">
                    <h:panelGrid id="enq" columns="2" columnClasses="FOX_LABEL_COL, FOX_INPUT_COL" width="50%">
                        ...
                        <h:panelGroup>
                            <h:selectOneMenu id="Customer_Code" styleClass="FOX_INPUT" required="true" 
                                value="#{foxyCustomerBrand.custBrandBean.custCode}" readonly="false"> 
                        ...
                        <h:panelGroup>
                            <t:inputTextHelp id="BrandCode" styleClass="FOX_INPUT"  readonly="false"
                                helpText="Text"
                                maxlength="10" size="10" required="true"
                                value="#{foxyCustomerBrand.custBrandBean.brandCode}">
                            </t:inputTextHelp>
                        ...
                        <h:panelGroup>
                            <t:inputTextHelp id="BrandDesc" styleClass="FOX_INPUT"  readonly="false"
                                ...
                                value="#{foxyCustomerBrand.custBrandBean.brandDesc}">
                            </t:inputTextHelp>
                        ...
                        <h:panelGroup>
                        <h:selectOneMenu id="Status" styleClass="FOX_INPUT" required="true" value="#{foxyCustomerBrand.custBrandBean.status}">
                        ...
                        <h:panelGroup>
                            <h:inputTextarea rows="5" cols="50" id="Remark" styleClass="FOX_INPUT" required="false" 
                                value="#{foxyCustomerBrand.custBrandBean.remark}">
                            </h:inputTextarea>
                    ...
                    <h:panelGrid id="AddButton" columns="1" columnClasses="FOX_BUTTON" width="50%">
                        <h:panelGroup>
                            <h:commandButton id="Save" value="Save" action="#{foxyCustomerBrand.saveAdd}"/>
                        </h:panelGroup>
                    </h:panelGrid>
