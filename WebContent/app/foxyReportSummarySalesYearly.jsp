...
<f:view>
    ...
    <%-- Panel for Search --%>
    <%-- h:panelGrid id="SearchGrid" styleClass="tablebg" width="100%" rendered="#{foxySummarySalesRpt.search}" --%>
    <h:panelGrid id="SearchGrid" styleClass="tablebg" width="100%"  rendered="#{not foxySummarySalesRpt.list}">
        <h:outputText value="Sales Yearly Summary Report" styleClass="smalltitle" />
        <%--h:form id="SearchForm" rendered="#{foxySummarySalesRpt.search}" --%>
    ...
    <%-- Panel for Listing --%>
    <h:panelGrid id="ListOrderGrid" styleClass="tablebg" rendered="#{foxySummarySalesRpt.list}" width="100%">        
        <h:form id="ListReportForm">
            <h:panelGrid id="Top" columns="1" columnClasses="FOX_LABEL_COL, FOX_INPUT_COL" width="100%">
                
                <h:outputText value="Sales Yearly Summary Report #{foxySummarySalesRpt.title}" styleClass="smalltitle" />
            </h:panelGrid>
            <h:panelGrid id="ListDisplay" columns="1" width="100%">
                <t:dataTable value="#{foxySummarySalesRpt.custSalesListModel}" var="custOrder"
                             id="DetailData"
                    ...
                    <t:column width="300px">
                        ...
                        <h:outputText value="#{custOrder.country}" escape="false"/>
                    </t:column>                                        
                    
                    <%-- JANUARY --%>
                    <t:column width="8%" styleClass="FOXY_ORDER_DETAIL_COL_R" rendered="#{foxySummarySalesRpt.displayUnit == 'DZN'}">
                        <f:facet name="header">
                        ...
                        <h:panelGroup rendered="#{custOrder.country != null}">
                            <h:outputText value="#{custOrder.qtyDznM01}">
                                <f:convertNumber minFractionDigits="2" maxFractionDigits="2"/>
                            </h:outputText>                            
                        </h:panelGroup>
                        <h:panelGroup rendered="#{custOrder.country == null}" styleClass="FOXY_REPORT_GRAND_TOTAL">
                            <h:outputText value="#{custOrder.qtyDznM01}">
                                <f:convertNumber minFractionDigits="2" maxFractionDigits="2"/>
                            </h:outputText>
                        </h:panelGroup>
                    </t:column>                    
                    <t:column width="8%" styleClass="FOXY_ORDER_DETAIL_COL_R" rendered="#{foxySummarySalesRpt.displayUnit == 'PCS'}">
                        <f:facet name="header">
                            <h:panelGrid columns="1" styleClass="FOXY_ORDER_DETAIL_HDR_R_NOPAD" width="100%"
                                         cellpadding="0" cellspacing="0" frame="0" border="0" rules="0">
