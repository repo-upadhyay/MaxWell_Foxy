...
<f:view>
    ...
    <h:panelGrid id="SearchGrid" styleClass="tablebg" width="100%"  rendered="#{not foxyQuotaReports.list}">
        <h:outputText value="Quota Outstanding Report" styleClass="smalltitle" />
    ...
    <h:panelGrid id="ListOrderGrid" styleClass="tablebg" rendered="#{foxyQuotaReports.list}" width="100%">        
        <h:form id="ListReportForm">
            <h:panelGrid id="Top" columns="1" columnClasses="FOX_LABEL_COL, FOX_INPUT_COL" width="100%">
                ...
                <h:outputText value="Quota Outstanding Report for #{foxyQuotaReports.title}" styleClass="smalltitle" />
            </h:panelGrid>
            <h:panelGrid id="ListDisplay" columns="1" columnClasses="FOX_LABEL_COL, FOX_INPUT_COL" width="100%">
                <t:dataTable value="#{foxyQuotaReports.quotaOutstandingReport}" var="quotaOutstdRpt"
                             id="DetailData"
                    ...
                    <t:column  width="8%">
                        ...
                        <h:outputText value="#{quotaOutstdRpt.orderId}#{quotaOutstdRpt.month}#{quotaOutstdRpt.location}" rendered="#{quotaOutstdRpt.quota != null}"/>
                    ...
                    <t:column width="8%" styleClass="FOXY_ORDER_DETAIL_COL_R">
                        ...
                        <h:outputText value="#{quotaOutstdRpt.qtyPcs / 12}" rendered="#{quotaOutstdRpt.quota != null}">
                            <f:convertNumber minFractionDigits="2" maxFractionDigits="2"/>
                        </h:outputText>
                        <h:outputText styleClass="FOXY_REPORT_GRAND_TOTAL" value="#{quotaOutstdRpt.qtyPcs / 12}" rendered="#{quotaOutstdRpt.quota == null}">
                            <f:convertNumber minFractionDigits="2" maxFractionDigits="2"/>
                        </h:outputText> 
                    </t:column>                    
