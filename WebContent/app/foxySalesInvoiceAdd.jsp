...
<f:view>
    ...
    <t:saveState value="#{foxySalesInvoice.salesInvoiceBean.currency}"/> 
    <t:saveState value="#{foxySalesInvoice.salesInvoiceBean.invdate}"/> 
    <t:saveState value="#{foxySalesInvoice.salesInvoiceBean.cmtval}"/> 
    <t:saveState value="#{foxySalesInvoice.salesInvoiceBean.fobval}"/> 
    <t:saveState value="#{foxySalesInvoice.salesInvoiceBean.revenue}"/> 
    ...
    <h:panelGrid id="AddSalesInvGrid" styleClass="tablebg" width="100%">
        <h:outputText value="New Sales Invoice" styleClass="smalltitle" />
        <h:form id="AddSalesInvForm">
            <h:panelGrid id="enq" columns="2" columnClasses="FOX_LABEL_COL, FOX_INPUT_COL" width="50%">
                ...
                <h:panelGroup>
                    <t:inputTextHelp id="InvoiceNo" styleClass="FOX_INPUT"
                                     ...
                                     value="#{foxySalesInvoice.salesInvoiceBean.invno}">
                    </t:inputTextHelp>
                ...
                <h:panelGroup>
                    <a4j:region id="a4j_invDate" renderRegionOnly="false" selfRendered="true">
                        <t:inputCalendar id="Date" styleClass="FOX_INPUT" value="#{foxySalesInvoice.salesInvoiceBean.invdate}"  popupDateFormat="yyyyMMdd" renderAsPopup="true">
                ...
                <h:panelGroup >
                    <h:selectOneMenu id="Customer_Code" value="#{foxySalesInvoice.salesInvoiceBean.custcode}"
                ...
                <h:panelGroup >
                    <t:inputTextHelp id="BrandCode" styleClass="FOX_INPUT"
                                     ...
                                     value="#{foxySalesInvoice.salesInvoiceBean.custbrand}">
                    </t:inputTextHelp>
                ...
                <h:panelGroup >
                    <t:inputTextHelp id="divcode" styleClass="FOX_INPUT"
                                     ...
                                     value="#{foxySalesInvoice.salesInvoiceBean.destination}">
                    </t:inputTextHelp>
                ...
                <h:panelGroup>
                    <a4j:region id="a4j_invValue1" renderRegionOnly="false" selfRendered="true">
                        <h:inputText id="FOBValue" styleClass="FOX_INPUT" maxlength="12" size="15" required="true" value="#{foxySalesInvoice.salesInvoiceBean.fobval}">
                ...
                <h:panelGroup>
                    <a4j:region id="a4j_invValue2" renderRegionOnly="false" selfRendered="true">
                        <h:inputText id="CMTValue" styleClass="FOX_INPUT" maxlength="12" size="15" required="false" value="#{foxySalesInvoice.salesInvoiceBean.cmtval}">
                ...
                <h:panelGroup>
                    <a4j:region id="a4j_invValue4" renderRegionOnly="false" selfRendered="true">
                        <h:inputText id="Revenue" styleClass="FOX_INPUT" maxlength="12" size="15" required="true" value="#{foxySalesInvoice.salesInvoiceBean.revenue}">
                ...
                <h:panelGroup>
                    <a4j:region id="ajaxregion2" renderRegionOnly="false" selfRendered="true">                            
                        <h:selectOneMenu id="Currency" styleClass="FOX_INPUT" required="true" value="#{foxySalesInvoice.salesInvoiceBean.currency}">
                ...
                <h:panelGroup>
                    <h:inputText id="FOBbasevalue" style="background-color: #ffff00;"  styleClass="FOX_INPUT" maxlength="15" size="15" required="true" 
                                 value="#{foxySalesInvoice.salesInvoiceBean.fobbaseval}">
                    </h:inputText>
                ...
                <h:panelGroup>
                    <h:inputText id="CMTbasevalue" style="background-color: #ffff00;"  styleClass="FOX_INPUT" maxlength="15" size="15" required="false" 
                                 value="#{foxySalesInvoice.salesInvoiceBean.cmtbaseval}">
                    </h:inputText>
                    <t:outputText value="This field if auto-caculate, Empty means no Forex rate info"  styleClass="FOX_ERROR"/>
                    <a4j:status for="ajaxregion2">
                        <f:facet name="start">
                ...
                <h:panelGroup>
                    <h:inputText id="RevenueBaseVal" style="background-color: #ffff00;"  styleClass="FOX_INPUT" maxlength="15" size="15" required="true" 
                                 value="#{foxySalesInvoice.salesInvoiceBean.revenuebaseval}">
                    </h:inputText>
                    <t:outputText value="This field if auto-caculate, Empty means no Forex rate info"  styleClass="FOX_ERROR"/>
                    <a4j:status for="ajaxregion2">
                        <f:facet name="start">
                ...
                <h:panelGroup>
                    <h:selectOneMenu id="ShipmentType" styleClass="FOX_INPUT" required="false" value="#{foxySalesInvoice.salesInvoiceBean.shipmode}">
                ...
                <h:panelGroup>
                    <h:inputText id="Vessel" styleClass="FOX_INPUT" value="#{foxySalesInvoice.salesInvoiceBean.vessel}" maxlength="25" 
                ...
                <h:panelGroup>
                    <h:inputText id="StyleCode" styleClass="FOX_INPUT" value="#{foxySalesInvoice.salesInvoiceBean.stylecode}" maxlength="30" 
                ...
                <h:panelGroup>
                    <h:inputText id="RefDoc" styleClass="FOX_INPUT" value="#{foxySalesInvoice.salesInvoiceBean.refdoc}" maxlength="25" 
                                 size="25" required="false">
                    </h:inputText>
                ...
                <h:panelGroup>
                    <h:inputText id="Remarks" styleClass="FOX_INPUT" value="#{foxySalesInvoice.salesInvoiceBean.remarks}" maxlength="128" 
            ...
            <h:panelGrid id="AddButton" columns="1" columnClasses="FOX_BUTTON" width="50%">
                <h:panelGroup>
                    <h:commandButton id="Save" value="Save" action="#{foxySalesInvoice.saveAdd}"/>
