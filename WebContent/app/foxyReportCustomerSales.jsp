...
<f:view>
    ...
    <%-- Panel for Search --%>
    <%-- h:panelGrid id="SearchGrid" styleClass="tablebg" width="100%" rendered="#{foxyCustomerSalesRpt.search}" --%>
    <h:panelGrid id="SearchGrid" styleClass="tablebg" width="100%"  rendered="#{not foxyCustomerSalesRpt.list}">
        <h:outputText value="Customer Sales Report" styleClass="smalltitle" />
        <%--h:form id="SearchForm" rendered="#{foxyCustomerSalesRpt.search}" --%>

        <h:form id="SearchForm">
            <t:saveState value="#{foxyCustomerSalesRpt.country}"/>
            <t:saveState value="#{foxyCustomerSalesRpt.mainfactory}"/>
            <t:saveState value="#{foxyCustomerSalesRpt.custCode}"/>
            <t:saveState value="#{foxyCustomerSalesRpt.custDivision}"/>
            <t:saveState value="#{foxyCustomerSalesRpt.brand}"/>
            <t:saveState value="#{foxyCustomerSalesRpt.cnameCode}"/>
            ...
            <h:panelGrid id="SearchInput" columns="2" columnClasses="FOX_LABEL_COL, FOX_INPUT_COL" width="50%">                        
                ...
                <h:panelGroup >
                    <h:selectOneMenu id="CName" value="#{foxyCustomerSalesRpt.cnameCode}" styleClass="FOX_INPUT" required="true" immediate="false">
                ...
                <h:panelGroup>
                    <a4j:region id="ajaxregioncountryfactory" renderRegionOnly="false" selfRendered="true">
                        <h:selectOneMenu id="Country" styleClass="FOX_INPUT" 
                                         required="true" 
                                         immediate="true"
                                         value="#{foxyCustomerSalesRpt.country}">
                ...
                <h:panelGroup>
                    <h:selectOneMenu id="factory" styleClass="FOX_INPUT" 
                                     required="true" 
                                     immediate="true"
                                     value="#{foxyCustomerSalesRpt.mainfactory}">
                        <f:selectItems value="#{foxyCustomerSalesRpt.factoryByCountryList}"/>
                    </h:selectOneMenu>
                ...
                <h:panelGroup>
                    <a4j:region id="ajaxregion1" renderRegionOnly="false" selfRendered="true">
                        <h:selectOneMenu id="CustomerCode" styleClass="FOX_INPUT" value="#{foxyCustomerSalesRpt.custCode}"
                ...
                <h:panelGroup>
                    <a4j:region id="ajaxregion2" renderRegionOnly="false" selfRendered="true">
                        <h:selectOneMenu id="BrandCode" styleClass="FOX_INPUT" value="#{foxyCustomerSalesRpt.brand}"
                                         style="width:220px; "  required="false" immediate="true"> 
                            <f:selectItems value="#{foxyCustomerSalesRpt.brandItemsList}"/>
                            <a4j:support event="onchange"  
                ...
                <h:panelGroup>                              
                    <h:selectOneMenu id="CustomerDivision" styleClass="FOX_INPUT" value="#{foxyCustomerSalesRpt.custDivision}"
                                     style="width:220px; " required="false" immediate="true"> 
                        <f:selectItems value="#{foxyCustomerSalesRpt.divisionItemsList}"/>
                    </h:selectOneMenu>                    
                ...
                <h:panelGroup>
                    <h:selectOneMenu id="Season" styleClass="FOX_INPUT" required="false" value="#{foxyCustomerSalesRpt.season}">
                ...
                <h:panelGroup>
                    <h:selectOneMenu id="Graphics" styleClass="FOX_INPUT" required="false" value="#{foxyCustomerSalesRpt.graphicTypeCode}">
                ...
                <h:panelGroup>
                    <h:selectOneMenu id="Colouring" styleClass="FOX_INPUT" required="false" value="#{foxyCustomerSalesRpt.colourTypeCode}">
                ...
                <h:panelGroup>
                    <t:inputCalendar id="FromDate" styleClass="FOX_INPUT" value="#{foxyCustomerSalesRpt.fromDate}"  
                ...
                <h:panelGroup>
                    <t:inputCalendar id="ToDate" styleClass="FOX_INPUT" value="#{foxyCustomerSalesRpt.toDate}"  
                                     required="true" popupDateFormat="yyyyMMdd" renderAsPopup="true"
                                     helpText="YYYYMMDD" />    
                ...
                <h:panelGroup>                              
                    <h:selectOneMenu id="UpdUserId" styleClass="FOX_INPUT" value="#{foxyCustomerSalesRpt.userid}"
                                     style="width:220px; " required="false" immediate="true"> 
                        <f:selectItems value="#{foxyCustomerSalesRpt.userItemsList}"/>
                    </h:selectOneMenu>                    
                    <h:message errorClass="FOX_ERROR" for="UpdUserId" showDetail="true" showSummary="true"/>
                </h:panelGroup>                                

                <h:commandButton id="Submit"  value="Submit" action="#{foxyCustomerSalesRpt.search}"/>
                <h:commandButton id="getXLSX" value="Extract Excel XLSX" action="#{foxyCustomerSalesRpt.CustSalesListModelXLSX}">
    ...
    <%-- Panel for Listing --%>
    <h:panelGrid id="ListOrderGrid" styleClass="tablebg" rendered="#{foxyCustomerSalesRpt.list}" width="100%">        
        <h:form id="ListReportForm">
            <h:panelGrid id="Top" columns="1" columnClasses="FOX_LABEL_COL, FOX_INPUT_COL" width="100%">

                <h:outputText value="Customer Sales Report #{foxyCustomerSalesRpt.title}" styleClass="smalltitle" />
            </h:panelGrid>
            <h:panelGrid id="ListDisplay" columns="1" width="100%">
                <t:dataTable value="#{foxyCustomerSalesRpt.custSalesListModel}" var="custOrder"
                             id="DetailData"
