...
<f:view>
    ...
    <%-- Panel for Search --%>
    <h:panelGrid id="SearchGrid" styleClass="tablebg" rendered="#{not foxyLocalMerchandiserReports.list}" width="100%">
        <h:outputText value="Local Merchandiser Monthly Report" styleClass="smalltitle" />
            ...
            <h:panelGrid id="SearchInput" columns="2" columnClasses="FOX_LABEL_COL, FOX_INPUT_COL" width="50%">               
                ...
                <h:panelGroup>
                    <t:inputTextHelp id="Year" styleClass="FOX_INPUT" required="true" 
                                     helpText="YYYY"  value="#{foxyLocalMerchandiserReports.year}"/>
                ...
                <h:panelGroup>
                    <t:inputTextHelp id="Month" styleClass="FOX_INPUT" required="true" 
                                     helpText="MM" value="#{foxyLocalMerchandiserReports.month}"/>
    ...
    <h:panelGrid id="ListOrderGrid" styleClass="tablebg" rendered="#{foxyLocalMerchandiserReports.list}" width="100%">        
        <h:form id="ListReportForm">
            <h:panelGrid id="Top" columns="1" columnClasses="FOX_LABEL_COL, FOX_INPUT_COL" width="100%">                
                <h:outputText value="Local Merchandiser Monthly Report for #{foxyLocalMerchandiserReports.title}" styleClass="smalltitle" />                
            </h:panelGrid>
