...
<f:view>
    ...
    <table class='box' width='100%'>
        <tr><td>        
                ...
                <h:panelGrid id="AddCustomerGrid" styleClass="tablebg" width="100%">
                    <h:outputText value="New Customer" styleClass="smalltitle" />
                    <h:form id="AddCustomerForm">
                        <h:panelGrid id="enq" columns="2" columnClasses="FOX_LABEL_COL, FOX_INPUT_COL" width="50%">
                            ...
                            <h:panelGroup>
                                <t:inputTextHelp id="Customer_Code" styleClass="FOX_INPUT"
                                                 helpText="Text"
                                                 maxlength="10" size="10" required="true"
                                                 value="#{foxyCustomer.custBean.custCode}">
                                </t:inputTextHelp>
                            ...
                            <h:panelGroup>
                                <t:inputTextHelp id="Customer_Name" styleClass="FOX_INPUT"
                                                 ...
                                                 value="#{foxyCustomer.custBean.custName}">
                                </t:inputTextHelp>
                            ...
                            <h:panelGroup>
                                <t:selectBooleanCheckbox id="Customer_Federated" styleClass="FOX_INPUT"
                                                         required="false"
                                                         value="#{foxyCustomer.custBean.federated}"/>
                            ...
                            <h:panelGroup>
                                <t:inputTextHelp id="payTerm" styleClass="FOX_INPUT"
                                                 ...
                                                 value="#{foxyCustomer.custBean.payTerm}"/>
                            ...
                            <h:panelGroup>
                                <t:inputTextHelp id="Address" styleClass="FOX_INPUT"
                                                 ...
                                                 value="#{foxyCustomer.custBean.custAddress}">
                                </t:inputTextHelp>
                            ...
                            <h:panelGroup>
                                <t:inputTextHelp id="Phone_Number" styleClass="FOX_INPUT"
                                                 ...
                                                 value="#{foxyCustomer.custBean.custTel}">
                                </t:inputTextHelp>
                            ...
                            <h:panelGroup>
                                <t:inputTextHelp id="Fax_Number" styleClass="FOX_INPUT"
                                                 helpText="Text"
                                                 maxlength="20" size="20" required="false"
                                                 value="#{foxyCustomer.custBean.custFax}">
                                </t:inputTextHelp>
                        ...
                        <h:panelGroup>
                        <h:selectOneMenu id="Status" styleClass="FOX_INPUT" required="true" value="#{foxyCustomer.custBean.status}">
                        ...
                        <h:message errorClass="FOX_ERROR" for="Status" showDetail="true" showSummary="true"/>
                            ...
                            <h:panelGroup>
                                <h:inputTextarea rows="5" cols="50" id="Remark" styleClass="FOX_INPUT" required="false" 
                                                 value="#{foxyCustomer.custBean.remark}">
                                </h:inputTextarea>
                        ...
                        <h:panelGrid id="AddButton" columns="1" columnClasses="FOX_BUTTON" width="50%">
                            <h:panelGroup>
                                <h:commandButton id="Save" value="Save" action="#{foxyCustomer.saveAdd}"/>
                            </h:panelGroup>
                        </h:panelGrid>
