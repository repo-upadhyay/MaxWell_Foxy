...
<f:view>
    ...
    <table class="box" width="100%">
        <tr><td>
                ...
                <h:panelGrid id="UpdSupplierGrid" styleClass="tablebg" width="100%">
                    <h:outputText value="Update Supplier" styleClass="smalltitle"/>
                    <h:form id="UpdSupplierForm">
                        <h:panelGrid id="enq" columns="2" columnClasses="FOX_LABEL_COL, FOX_INPUT_COL" width="50%">
                            ...
                            <h:panelGroup>
                                <t:inputTextHelp id="Supplier_Code" styleClass="FOX_INPUT_RO" readonly="true"
                                                 helpText="Text"
                                                 maxlength="10" size="10" required="true"
                                                 value="#{foxySupplier.dbEditSupBean.supCode}">
                                </t:inputTextHelp>
                            ...
                            <h:panelGroup>
                                <h:selectOneMenu id="SupplierItem_Code" styleClass="FOX_INPUT" required="true" 
                                                 value="#{foxySupplier.dbEditSupBean.itemCode}" readonly="false"> 
                            ...
                            <h:panelGroup>
                                <t:inputTextHelp id="Supplier_Name" styleClass="FOX_INPUT"
                                                 ...
                                                 value="#{foxySupplier.dbEditSupBean.supName}">
                                </t:inputTextHelp>
                        ...
                        <h:panelGrid columns="1" columnClasses="FOX_BUTTON" width="50%">
                            <h:panelGroup>
                                <h:commandButton id="Save" value="Save" action="#{foxySupplier.saveEdit}"/>
                            </h:panelGroup>
                        </h:panelGrid>
                    </h:form>
                </h:panelGrid>
