...
<f:view>
    ...
    <t:saveState value="#{foxyInventory.dbEditInventoryBean.invType}"/>
    <t:saveState value="#{foxyInventory.dbEditInventoryBean.currency}"/> 
    <t:saveState value="#{foxyInventory.dbEditInventoryBean.invoiceDate}"/> 
    <t:saveState value="#{foxyInventory.dbEditInventoryBean.value}"/>
    
    <h:messages errorClass="FOX_ERROR" showDetail="true" showSummary="true"/>
    
    
    <%-- Panel for Add --%>
    <h:panelGrid id="InvEditGrid" styleClass="tablebg" width="100%">
        <h:outputText value="Edit F&A Invoice" styleClass="smalltitle"/>
        <%-- Update & Add Form --%>
        <h:form id="InvEditForm" rendered="true">
            
            <h:panelGrid columns="1" style="vertical-align: top;" width="100%" cellpadding="0" cellspacing="0" border="0" frame="none" rules="none">
                <%-- START of column 1 --%>
                <h:panelGrid id="invedit" columns="2" columnClasses="FOXY_SCREEN_2COL,FOXY_SCREEN_2COL" width="100%" cellpadding="0" cellspacing="0" border="0" frame="none" rules="none">
                    <h:panelGrid id="UpdAddInput1_1" columns="2" columnClasses="FOX_LABEL_COL_2, FOX_INPUT_COL_2" width="100%">
                        ...
                        <h:panelGroup>
                            <h:inputText id="InvoiceNumber" styleClass="FOX_INPUT_RO" value="#{foxyInventory.dbEditInventoryBean.invoice}" maxlength="20" 
                                         size="20" readonly="true" required="true">
                            </h:inputText>
                        ...
                        <h:panelGroup>
                            <a4j:region id="ajaxregion1" renderRegionOnly="false" selfRendered="true">
                                <h:selectOneMenu id="type" styleClass="FOX_INPUT" required="true" value="#{foxyInventory.dbEditInventoryBean.invType}">
                                    ...
                                    <a4j:support id="ajitemtypecode" event="onchange" action="#{foxyInventory.onItemTypeChange}" 
                                                 reRender="supplier" ajaxSingle="true">
                                    </a4j:support>                                     
                                </h:selectOneMenu>                                
                            </a4j:region>
                        ...
                        <h:panelGroup>
                            <h:selectOneMenu id="supplier" styleClass="FOX_INPUT" required="true" value="#{foxyInventory.dbEditInventoryBean.supplier}">
                        ...
                        <h:panelGroup>
                            <h:inputText id="ItemDesc" styleClass="FOX_INPUT" value="#{foxyInventory.dbEditInventoryBean.itemDesc}" maxlength="128" 
                        ...
                        <h:panelGroup>
                            <a4j:region id="a4j_invDate" renderRegionOnly="false" selfRendered="true">
                                <t:inputCalendar id="Date" styleClass="FOX_INPUT" value="#{foxyInventory.dbEditInventoryBean.invoiceDate}"  popupDateFormat="yyyyMMdd" renderAsPopup="true">
                        ...
                        <h:panelGroup>
                            <h:inputText id="Quantity" styleClass="FOX_INPUT" maxlength="12" size="15" required="true" value="#{foxyInventory.dbEditInventoryBean.quantity}"/>
                            <h:message errorClass="FOX_ERROR" for="Quantity" showDetail="true" showSummary="true"/>
                        </h:panelGroup>                                          
                        
                        <t:outputLabel for="Unit" value="Unit:" />                    
                        <h:panelGroup>
                            <h:selectOneMenu id="Unit" styleClass="FOX_INPUT" required="true" value="#{foxyInventory.dbEditInventoryBean.unit}">
                        ...
                        <h:panelGroup>
                            <a4j:region id="a4j_invValue" renderRegionOnly="false" selfRendered="true">
                                <h:inputText id="Value" styleClass="FOX_INPUT" maxlength="12" size="15" required="true" value="#{foxyInventory.dbEditInventoryBean.value}">
                        ...
                        <h:panelGroup>
                            <a4j:region id="ajaxregion2" renderRegionOnly="false" selfRendered="true">                            
                                <h:selectOneMenu id="Currency" styleClass="FOX_INPUT" required="true" value="#{foxyInventory.dbEditInventoryBean.currency}">
                        ...
                        <h:panelGroup>
                            <h:inputText id="basevalue" style="background-color: #ffff00;" styleClass="FOX_INPUT" maxlength="12" size="15" required="true" value="#{foxyInventory.dbEditInventoryBean.baseValue}">
                            </h:inputText>
                        ...
                        <h:panelGroup>
                            <h:inputText id="Remarks" styleClass="FOX_INPUT" value="#{foxyInventory.dbEditInventoryBean.remarks}" maxlength="128" 
                                         size="50" required="false">
                            </h:inputText>
                ...
                <h:panelGrid id="SaveButton" columns="1" columnClasses="FOX_BUTTON" width="50%">
                    <h:panelGroup>
                        <h:commandButton id="Save" value="Save" action="#{foxyInventory.saveEdit}"/>
                    </h:panelGroup>
                </h:panelGrid>
            </h:panelGrid>
        </h:form>
