                        ...
                        <t:dataTable id="ListDataDisplayOuter"
                            ...
                            <h:column>
                                <t:dataTable var="prodSch" value="#{outerRowBean.col0}" 
                                    ...
                                    <h:column>
                                        <h:panelGrid columns="1" columnClasses="columnTop,columnTop,columnTop" width="100%" bgcolor="red" border="0"  cellpadding="0" cellspacing="0">
                                            <h:panelGrid columns="1" width="100%" bgcolor="red" border="0"  cellpadding="0" cellspacing="0">
                                                ...
                                                <h:outputText value="VesselDateRange:" />
                                                <h:outputText value="SewDateRange:" />                                                                                                                                
                                ...
                                <t:dataTable var="prodSch" value="#{outerRowBean.col0}" 
                                    ...
                                    <h:column>
                                        <h:panelGrid columns="1" columnClasses="columnTop,columnTop,columnTop" width="100%" bgcolor="red" border="0"  cellpadding="0" cellspacing="0">
                                            <h:panelGrid columns="1" width="100%" bgcolor="red" border="0"  cellpadding="0" cellspacing="0">
                                                <h:graphicImage url="/app/DisplayPicture?imageid=#{prodSch.refNo}" height="70" width="62" />
                                                <h:outputText value="#{prodSch.refNo}#{prodSch.lotsString}"/>
                                                <h:outputText value="#{prodSch.vesselDateRange}"/>
                                                <h:outputText value="#{prodSch.sewDateRange}"/>
