    ...
    <table class="box" width="100%">
        <tr><td>
            ...
            Without save state, brandList will be empty and will get "Value is not a valid option" error message --%>
                <t:saveState value="#{foxyQuotaEntry.dbEditQtaEntryBean.country}"/>
                ...
                <h:panelGrid id="AddQuotaEntryGrid" styleClass="tablebg" width="100%">
                    ...
                    <h:form id="AddQuotaMastForm">
                        <h:panelGrid id="enq" columns="2" columnClasses="FOX_LABEL_COL, FOX_INPUT_COL" width="50%">
                            ...
                            <h:panelGroup>
                                <a4j:region id="ajaxregion1" renderRegionOnly="false" selfRendered="true">
                                    <h:selectOneMenu id="Country" styleClass="FOX_INPUT" required="true" value="#{foxyQuotaEntry.dbEditQtaEntryBean.country}">
                            ...
                            <h:panelGroup>
                                <h:selectOneMenu id="QuotaMast_Code" styleClass="FOX_INPUT" value="#{foxyQuotaEntry.dbEditQtaEntryBean.quota}"
                            ...
                            <h:panelGroup>
                                <t:inputCalendar  id="effDate" size="12" popupGotoString="go to today date" popupDateFormat="yyyyMMdd" renderAsPopup="true"
                                                  helpText="YYYYMMDD" value="#{foxyQuotaEntry.dbEditQtaEntryBean.effDate}"
                            ...
                            <h:panelGroup>
                                <t:inputCalendar  id="expDate" size="12" popupGotoString="go to today date" popupDateFormat="yyyyMMdd" renderAsPopup="true"
                                                  helpText="YYYYMMDD" value="#{foxyQuotaEntry.dbEditQtaEntryBean.expDate}"
                                                  required = "true" styleClass="FOX_INPUT">
                                </t:inputCalendar>
                            ...
                            <h:panelGroup>
                                <h:selectOneMenu id="type" styleClass="FOX_INPUT" required="true" value="#{foxyQuotaEntry.dbEditQtaEntryBean.type}">
                            ...
                            <h:panelGroup>                            
                                <t:inputTextHelp id="Qty" styleClass="FOX_INPUT"
                                                 ...
                                                 value="#{foxyQuotaEntry.dbEditQtaEntryBean.quotaQty}">
                                </t:inputTextHelp>                                
                            ...
                            <h:panelGroup>                            
                                <t:inputTextHelp id="Cost" styleClass="FOX_INPUT"
                                                 helpText="99999.99"
                                                 maxlength="12" size="12" required="true"
                                                 value="#{foxyQuotaEntry.dbEditQtaEntryBean.cost}">
                                </t:inputTextHelp>
                            ...
                            <h:panelGroup>                            
                                <t:inputTextHelp id="QuotaDocRefNo" styleClass="FOX_INPUT"
                                                 ...
                                                 value="#{foxyQuotaEntry.dbEditQtaEntryBean.quotaRefNo}">
                                </t:inputTextHelp>
                        ...
                        <h:panelGroup>
                        <h:selectOneMenu id="Status" styleClass="FOX_INPUT" required="true" value="#{foxyQuotaEntry.dbEditQtaEntryBean.status}">
                        ...
                        <h:panelGrid id="AddButton" columns="1" columnClasses="FOX_BUTTON" width="50%">
                            <h:panelGroup>
                                <h:commandButton id="Save" value="Save" action="#{foxyQuotaEntry.saveEdit}"/>
                            </h:panelGroup>
                        </h:panelGrid>
                    </h:form>
                </h:panelGrid>
