    ...
    <table class="box" width="100%">
        <tr><td>        
            ...
            <h:panelGrid id="UpdAddGrid" styleClass="tablebg" width="100%">
                <%-- Title for Add --%>
                <h:outputText value="Add Production schedule" styleClass="smalltitle"/>
                ...
                <h:form id="UpdAddForm">
                    ...
                    <t:saveState value="#{foxyProdScheduleAdd.prodSchBean.sewStart}"/>
                    <t:saveState value="#{foxyProdScheduleAdd.prodSchBean.sewEnd}"/>
                    <t:saveState value="#{foxyProdScheduleAdd.prodSchBean.refNo}"/>
                    <t:saveState value="#{foxyProdScheduleAdd.lotsMap}"/>
                    <t:saveState value="#{foxyProdScheduleAdd.checkStatus}"/>
                    <t:saveState value="#{foxyProdScheduleAdd.addLotStat}"/>
                    <t:saveState value="#{foxyProdScheduleAdd.selectedLots}"/>
                    <t:saveState value="#{foxyProdScheduleAdd.prodLotBean}"/>
                    ...
                    <h:panelGrid columns="1"  width="100%" cellpadding="0" cellspacing="0" border="0" frame="none" rules="none">                        
                        <h:panelGrid id="UpdAddInput" columns="2" columnClasses="FOX_LABEL_COL, FOX_INPUT_COL" width="50%">
                            ...
                            <h:panelGroup>
                                <h:selectOneMenu id="Location" styleClass="FOX_INPUT" required="true" value="#{foxyProdScheduleAdd.prodSchBean.ccode}">
                            ...
                            <h:panelGroup>                        
                                <t:inputTextHelp id="lineNo" styleClass="FOX_INPUT"
                                    ...
                                    value="#{foxyProdScheduleAdd.prodSchBean.lineNo}">
                        ...
                        <h:panelGrid columns="1"  width="100%" cellpadding="0" cellspacing="0" border="0" frame="none" rules="none">                            
                                ...
                                <h:panelGroup>
                                    <a4j:region id="ajaxregion1" renderRegionOnly="false" selfRendered="true">
                                        <t:inputTextHelp id="RefNo" styleClass="FOX_INPUT"
                                            ...
                                            value="#{foxyProdScheduleAdd.prodSchBean.refNo}" >
                                            <a4j:support id="ajrefno" event="onchange" action="#{foxyProdScheduleAdd.onRefNoChange}"
                                                reRender="checkStatus,Save,subRef" ajaxSingle="true">
                                            </a4j:support>
                                        </t:inputTextHelp>
                                    </a4j:region>
                                    <t:outputText id="checkStatus" styleClass="FOX_ERROR" value="#{foxyProdScheduleAdd.checkStatus}"/>
                                ...
                                <h:panelGroup>
                                    <a4j:region id="ajaxregion2" renderRegionOnly="false" selfRendered="true">
                                        <t:inputTextHelp id="SubRefNo" styleClass="FOX_INPUT"
                                            ...
                                            value="#{foxyProdScheduleAdd.prodLotBean.lot}" >
                                ...
                                <h:panelGroup>
                                    <a4j:region id="ajaxregion3" renderRegionOnly="false" selfRendered="true">
                                        <t:inputCalendar  id="lotDate" size="12" popupGotoString="go to today date" popupDateFormat="yyyyMMdd" renderAsPopup="true"
                                            helpText="YYYYMMDD" value="#{foxyProdScheduleAdd.prodLotBean.vesselDate}"
                                            required = "false" styleClass="FOX_INPUT" immediate="true">
                                            <a4j:support  event="onchange" ajaxSingle="true" eventsQueue="eq1"/>
                                        </t:inputCalendar>                                    
                                        <h:message errorClass="FOX_ERROR" for="lotDate" showDetail="true" showSummary="true"/>
                                        <a4j:commandButton id="add_items" value="Add Lot" ajaxSingle="false" immediate="true" action="#{foxyProdScheduleAdd.onAddSubRefNo}" 
                                        reRender="subRefList,addLotStatus" eventsQueue="eq1"/>
                                    </a4j:region>
                                    <t:outputText id="addLotStatus" styleClass="FOX_ERROR" value="#{foxyProdScheduleAdd.addLotStat}"/>
                                </h:panelGroup>
                                        
                                <t:outputLabel for="subRefList" value="Vessel Date/Lots:" />
                                <h:panelGroup>
                                    <a4j:region id="ajaxregion4" renderRegionOnly="false" selfRendered="true">
                                        <h:selectManyListbox id="subRefList" style="width:200px; height:60px " styleClass="FOX_INPUT" required="false" immediate="true" value="#{foxyProdScheduleAdd.selectedLots}">
                                            <f:selectItems value="#{foxyProdScheduleAdd.lotsListItems}"/>
                                            <a4j:support  event="onchange" ajaxSingle="true" eventsQueue="eq1"/>
                                        </h:selectManyListbox>
                                        <a4j:commandButton id="del_items" value="Delete Lot" ajaxSingle="false" immediate="true" action="#{foxyProdScheduleAdd.delLotsListItem}" 
                            ...
                            <h:panelGrid id="UpdAddInput21" columns="2" columnClasses="FOX_LABEL_COL, FOX_INPUT_COL" width="50%">
                                ...
                                <h:panelGroup>                        
                                    <t:inputTextHelp id="DailyProdQty" styleClass="FOX_INPUT"
                                        ...
                                        value="#{foxyProdScheduleAdd.prodSchBean.dailyProdQty}">
                            ...
                            <h:panelGrid id="UpdAddInputAjax21" columns="2" columnClasses="FOX_LABEL_COL, FOX_INPUT_COL" width="50%">
                                ...
                                <h:panelGroup>
                                    <t:inputCalendar  id="SewStart" size="12" popupGotoString="go to today date" popupDateFormat="yyyyMMdd" renderAsPopup="true"
                                        helpText="YYYYMMDD" value="#{foxyProdScheduleAdd.prodSchBean.sewStart}"
                                ...
                                <h:panelGroup>
                                    <t:inputCalendar  id="SewEnd" size="12" popupGotoString="go to today date" popupDateFormat="yyyyMMdd" renderAsPopup="true"
                                        helpText="YYYYMMDD" value="#{foxyProdScheduleAdd.prodSchBean.sewEnd}"
                                        required = "true" styleClass="FOX_INPUT">
                                    </t:inputCalendar>
                                ...
                                <h:panelGroup>                        
                                    <t:inputTextHelp id="Groups" styleClass="FOX_INPUT"
                                        ...
                                        value="#{foxyProdScheduleAdd.prodSchBean.groups}">                                        
                                    </t:inputTextHelp>
                                ...
                                <h:panelGroup>                        
                                    <t:inputTextHelp id="DaysToComplete" styleClass="FOX_INPUT"
                                        ...
                                        value="#{foxyProdScheduleAdd.prodSchBean.numOfDay}">
                            ...
                            <h:panelGrid id="UpdAddInput3" columns="2" columnClasses="FOX_LABEL_COL, FOX_INPUT_COL" width="50%">                        
                                ...
                                <h:panelGroup>                        
                                    <t:inputTextHelp id="ordQty" styleClass="FOX_INPUT"
                                        helpText="9999999999"
                                        maxlength="10" size="10" required="true" 
                                        value="#{foxyProdScheduleAdd.prodSchBean.ordQty}">
                                        <f:convertNumber integerOnly="true" maxIntegerDigits="10" groupingUsed="false"/>
                                    </t:inputTextHelp>
                                ...
                                <h:panelGroup>                        
                                    <t:selectBooleanCheckbox id="bySubCon" 
                                        ...
                                        required="false"
                                        value="#{foxyProdScheduleAdd.prodSchBean.bySubCon}">
                                ...
                                <h:panelGroup>
                                    <t:inputTextHelp id="Remark" styleClass="FOX_INPUT"
                                        ...
                                        value="#{foxyProdScheduleAdd.prodSchBean.remark}">                                        
                                    </t:inputTextHelp>
                                ...
                                <t:outputLabel for="Remark" value="Remark:" />
                                <h:panelGroup>
                                <h:inputTextarea rows="3" cols="30" id="Remark" styleClass="FOX_INPUT" required="false" value="#{foxyProdScheduleAdd.prodSchBean.remark}">
                                </h:inputTextarea>
                                <h:message errorClass="FOX_ERROR" for="Remark" showDetail="true" showSummary="true"/>
                                </h:panelGroup>
                                --%>
                            ...
                            <h:panelGrid id="AddButton" columns="1" columnClasses="FOX_BUTTON" width="50%">
                                <h:panelGroup>
                                    <h:commandButton id="Save"  value="Save" action="#{foxyProdScheduleAdd.saveAdd}" disabled="#{not foxyProdScheduleAdd.statusOk}"/>
                                </h:panelGroup>
                            </h:panelGrid>     
                        </h:panelGrid>
                    </h:panelGrid>
